 ...
 */
@Data
@ApiModel(value = "bbinFishingExpert", description = "bbinFishingExpert注单")
public class BetslipsBbinFishingExpertDto {
    ...
    @ApiModelProperty(name = "modified_date", value = "注单更新时间", example = "10000")
