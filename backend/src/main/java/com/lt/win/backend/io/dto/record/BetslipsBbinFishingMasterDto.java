 ...
 */
@Data
@ApiModel(value = "bbinGameMaster", description = "bbinGameMaster注单")
public class BetslipsBbinFishingMasterDto {
    ...
    @ApiModelProperty(name = "updated_at", value = "人民币汇率", example = "10000")
    private Integer updatedAt;

    @ApiModelProperty(name = "modified_date", value = "更新时间", example = "10000")
